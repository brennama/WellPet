package com.example.wellpet.ui.theme

import androidx.compose.ui.graphics.Color

val md_theme_light_primary = Color(0xFF30BDF4) //Primary
val md_theme_light_onPrimary = Color(0xFF0D4A62) //Primary darkest variant
val md_theme_light_primaryContainer = Color(0xFF9EE2FD) //Primary lightest variant
val md_theme_light_onPrimaryContainer = Color(0xFF2B2B2B) //Neutral 1
val md_theme_light_secondary = Color(0xFFA7D455) //Secondary 1
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFD3E5F5)
val md_theme_light_onSecondaryContainer = Color(0xFF0C1D29)
val md_theme_light_tertiary = Color(0xFF813E85)  //Secondary 2
val md_theme_light_onTertiary = Color(0xFFFFFFFF)
val md_theme_light_tertiaryContainer = Color(0xFFEADDFF)
val md_theme_light_onTertiaryContainer = Color(0xFF201634)
val md_theme_light_error = Color(0xFFF3292A) // Secondary 3
val md_theme_light_errorContainer = Color(0xFFFFDAD6)
val md_theme_light_onError = Color(0xFFFFFFFF)
val md_theme_light_onErrorContainer = Color(0xFF410002)
val md_theme_light_background = Color(0xFFFCFCFF)
val md_theme_light_onBackground = Color(0xFF1A1C1E)
val md_theme_light_surface = Color(0xFFFCFCFF) //surface, using for navbar background color
val md_theme_light_onSurface = Color(0xFF999999) //onSurface, using for navbar text
